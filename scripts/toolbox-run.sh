...
# NOTE: do not put a comment line inside the exec continuation below - on
# macOS bash 3.2 a comment breaks the backslash continuation and silently
# drops the trailing args (TOOLBOX_IMAGE, CLI_ARGS).
